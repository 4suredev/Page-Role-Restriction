 ...
 * Plugin URI: https://github.com/4suredev/Page-Role-Restriction
...
if(!function_exists('acc_admin_enqueue_scripts')){
...
if(!function_exists('acc_meta_init') && !function_exists('acc_meta_init') && !function_exists('acc_page_options_meta_box')){
...
if(!function_exists('acc_save_post_meta')){
...
if(!function_exists('acc_default_settings_menu') && !function_exists('acc_default_options_init') && !function_exists('acc_default_settings_options') ){
    ...
    function acc_default_settings_menu() {
        ...
        $menu_icon = ACC_PLUGIN_PATH.'img/icon-20x20.png';
        add_menu_page( 'Access Manager Page', 'Page Access Manager', 'manage_options', $menu_slug, 'acc_default_settings_options', $menu_icon, $menu_pos);
...
if(!function_exists('acc_get_page_list')){
...
if(!function_exists('acc_role_restriction_filter_content') && !function_exists('acc_get_all_post_types')){
