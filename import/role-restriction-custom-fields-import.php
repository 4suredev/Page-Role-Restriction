...
acf_add_local_field_group(array(
	...
	'fields' => array(
		...
		array(
			'key' => 'field_61f1f3959a68b',
			'label' => 'Page content target element',
			'name' => 'target_element',
			'type' => 'text',
			'instructions' => 'Enter the css target where the page content appears',
			'required' => 0,
			'conditional_logic' => 0,
			'wrapper' => array(
				'width' => '',
			...
			'default_value' => 'body .post-content',
			'placeholder' => '',
			'prepend' => '',
			'append' => '',
			'maxlength' => '',
